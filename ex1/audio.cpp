...
Audio::Audio(string* input_title, int input_price, float* input_sales_last_3_months, float input_MB, int input_minutes) :Publication(input_title, input_price), Sales(input_sales_last_3_months) {
    MB = input_MB;
